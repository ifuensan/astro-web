...
- Las primeras dos clases están en el curso *Bitcoin 101*, es necesario que tomes la clase de filosofía de Bitcoin.
...
En la parte práctica se proporcionarán tutoriales, talleres y videos hechos por nosotros para que puedas dar tus primeros pasos para ser un developer de Bitcoin. Algunas serán sesiones en vivo, para otros temas tienes que hacer sol@ por tu cuenta el aprendizaje y reforzar con sesiones para preguntas y respuestas. Durante todo momento habrá expertos ayudándote con tus dudas.  
...
<TeamCard 
  name="Iván Regalado" 
  role="Líder de Educación Mastering" 
  image="/ivan-regalado.png" 
